...
function EventRegistration({ eventId, eventName, collegeName }) { //here the collegeName is of event
  ...
  return (
    <div className='my-10 bg-white p-10 border-2 border-gray-400 text-black'>
      <form onSubmit={handleSubmit} className='grid [grid-template-columns:repeat(2,_1fr)] gap-8'>
        <p className='text-2xl text-center mb-5 [grid-column:span_2]'>Registration Form</p>
        ...
        <div className='[grid-column:span_2] flex justify-center'>
          <button
            type='submit'
